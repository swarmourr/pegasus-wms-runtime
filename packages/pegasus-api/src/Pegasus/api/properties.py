...
class Properties:
    ...
    _props = (
        ...
        "pegasus.metrics.app",
        "pegasus.runtime.prediction.enable",
        "pegasus.runtime.prediction.model.path",
        "pegasus.runtime.prediction.output.dir",
        "pegasus.runtime.prediction.sparse.threshold",
        "pegasus.runtime.prediction.interval.low",
        "pegasus.runtime.prediction.interval.high",
        "pegasus.runtime.prediction.slot.hostname",
        "pegasus.runtime.prediction.slot.cpu.count",
        "pegasus.runtime.prediction.slot.cpu.speed",
        "pegasus.runtime.prediction.slot.ram",
